...
Procedure InciA(mt:tmt;fila,col:byte;var cadena:st3;var descrip:st10;max:word; nreg:byte;vreg:tvreg;vcanal:tvcanal); //En un procedimiento siempre va Var
                   //Preguntar porque sin var no funciona, deberia funcionar igual                                  //A las variables que quiero hallar el min o max
begin
